...
describe("error handling", function() {
  ...
  it("throws error on missing value when value is unquoted", function() {
    try {
      ...
      chaiAssert.ok(errorChecker("key", 3, MissingValueError, e));
    }
  });
  ...
  it("throws error on missing value when value is quoted", function() {
    try {
      ...
      chaiAssert.ok(errorChecker("key", 9, MissingEndQuoteError, e));
    }
  });
  ...
  it("throws error on missing key", function() {
    try {
      ...
      chaiAssert.ok(errorChecker(undefined, 0, MissingKeyError,e));
    }
  });
...
try{
  ...
  chaiAssert.ok(errorChecker(undefined, 4, MissingAssignmentOperatorError,e));
}
  });
  ...
  it("throws error on incomplete key value pair", function() {
    try{
      ...
      chaiAssert.ok(errorChecker(undefined, 2, IncompleteKeyValuePairError,e));
    }
  });
